...
#
#  $ bin/test -s mordac.quota -t test_example.robot --all
#
# Run this robot test with robot server (which is faster):
#
# 1) Start robot server:
#
# $ bin/robot-server --reload-path src mordac.quota.testing.MORDAC_QUOTA_ACCEPTANCE_TESTING
#
# 2) Run robot tests:
#
# $ bin/robot src/mordac/quota/tests/robot/test_example.robot
#
